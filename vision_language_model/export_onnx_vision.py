...
class Gemma4_vision_wrapper(torch.nn.Module):
    ...
    def __init__(self, model: AutoModelForMultimodalLM, max_batch_size: int, max_cache_len: int):
        """ 
...
def build_dummy_inputs(
    ...
    tokenizer_output = processor.apply_chat_template(
        sample_messages, tokenize=True, return_dict=True,
    ...
    return input_ids, attention_mask, mm_token_type_ids, pixel_values, image_position_ids, position_ids
...
if __name__ == "__main__":
    ...
    input_ids, attention_mask, mm_token_type_ids, pixel_values, image_position_ids, position_ids = build_dummy_inputs(
        processor, sample_messages, model.device
    )
    ...
    try:
        exported = torch.export.export(
            wrapper,
            (input_ids, attention_mask, mm_token_type_ids, pixel_values, image_position_ids, position_ids),
            strict=False,
        )
